...
import '../providers/category_detail_providers.dart';
...
class CategoryDetailScreen extends ConsumerWidget {
  ...
  const CategoryDetailScreen({Key? key, required this.categoryId, required this.categoryName}) : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    const primary = Color(0xFF14C996);

    final overviewAsync = ref.watch(categoryOverviewProvider((id: categoryId, name: categoryName)));
    final expensesAsync = ref.watch(categoryExpensesByMonthProvider((id: categoryId, name: categoryName)));
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Container(height: 60, width: 2, color: Colors.white.withOpacity(0.3)),
                            _buildHeaderStat(
                              label: 'Total Expense',
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  '${(overview.progressPercent * 100).round()}%',
                        ...
                        const Row(
                          children: [
                            ...
                            SizedBox(width: 6),
                            Text('30% Of Your Expenses, Looks Good.', style: TextStyle(color: Color(0xFF14C996), fontSize: 12)),
                          ],
                        ),
                      ],
                    ),
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: const Text('Add Expenses', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                                ),
                              ),
  ...
  Widget _buildHeaderStat({required String label, required String value, required Color iconColor, required Color valueColor}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text(month, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Colors.black)),
            const Icon(Icons.calendar_today, color: Color(0xFF14C996), size: 20),
          ],
        ),
        const SizedBox(height: 12),
